...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Backimg: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    shoer_descriptio: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSliderSlider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bgDark: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    bgLight: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    btnLink1: Schema.Attribute.String;
    btnLink2: Schema.Attribute.String;
    btnText1: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shape1: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    shape2: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
