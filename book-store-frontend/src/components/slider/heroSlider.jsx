...
function heroSlider() {
  ...
  return (
    ...
    <Swiper
      ...
      modules={[Navigation, Pagination, Scrollbar, A11y , EffectFade , Mousewheel , Autoplay]}
      spaceBetween={0} 
      slidesPerView={1}
      navigation
  ...
  <div
    ...
    style={{
      backgroundImage: `url(http://localhost:1337${bgImg})`,
    }}
  >
    ...
    <span >+<Counter number={230} /> كتاب</span>
    <span>+<Counter number={241} /> زائر</span>
    <span>+<Counter number={313} /> كاتب</span>
    <span>+<Counter number={412} /> مهتم</span>
        ...
        <div className="col-lg-6 hero-img text-center">
          ...
          <img
            width="100%"
            src={`http://localhost:1337${slide.heroImg?.url}`}
            alt={slide.title}
          />
